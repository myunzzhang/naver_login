...
function isDateCompleted() {
    ...
    function isBirthRight() {
        let datePatter = /\d{1,2}/;
        console.log(typeof (dd.value)) //typeof 자료형검사 \\ stirng(문자) \\ number(숫자)
        if (!datePatter.test(dd.value) || Number(dd.value) < 1 || Number(dd.value) > 31) {
...
function checkPhoneNum() {
    let isphoneNum = /^([0]{1})([1]{1})([0-9]{1})([0-9]{3,4})([0-9]{4})$/;
    if (mobile.value == "") {
        error[7].innerHTML = "필수 정보 입니다."
